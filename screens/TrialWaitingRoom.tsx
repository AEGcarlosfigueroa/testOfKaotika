...
import { useWindowDimensions, StyleSheet, StatusBar, TouchableOpacity, Text, View, Image } from "react-native";
...
export default function TrialWaitingRoom()
{
    ...
    <>
        ...
        <Text style={styles.title}>AWAITING PLAYERS TO START TRIAL</Text>
